...
public class MegaJungleFeature extends HugeTreesFeature<HugeTreeFeatureConfig> {
   ...
   public boolean func_225557_a_(IWorldGenerationReader generationReader, Random rand, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, HugeTreeFeatureConfig p_225557_7_) {
      int i = this.func_227256_a_(rand, p_225557_7_);
      if (!this.hasRoom(generationReader, p_225557_3_, i, p_225557_7_)) {
         return false;
      } else {
         this.func_227252_c_(generationReader, rand, p_225557_3_.up(i), 2, p_225557_5_, p_225557_6_, p_225557_7_);

         for(int j = p_225557_3_.getY() + i - 2 - rand.nextInt(4); j > p_225557_3_.getY() + i / 2; j -= 2 + rand.nextInt(4)) {
            ...
            for(int i1 = 0; i1 < 5; ++i1) {
               ...
               this.func_227216_a_(generationReader, rand, blockpos, p_225557_4_, p_225557_6_, p_225557_7_);
            }
            ...
            for(int j1 = j - l1; j1 <= i2; ++j1) {
               int k1 = j1 - i2;
               this.func_227257_b_(generationReader, rand, new BlockPos(k, j1, l), 1 - k1, p_225557_5_, p_225557_6_, p_225557_7_);
            }
         }

         this.func_227254_a_(generationReader, rand, p_225557_3_, i, p_225557_4_, p_225557_6_, p_225557_7_);
         return true;
      }
   }
