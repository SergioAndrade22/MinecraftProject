...
public class VillageSiege {
         ...
         if (!playerentity.isSpectator()) {
            ...
            if (p_75529_1_.isVillage(blockpos) && p_75529_1_.getBiome(blockpos).getCategory() != Biome.Category.MUSHROOM) {
               for(int i = 0; i < 10; ++i) {
                  ...
                  Vec3d siegeLocation = this.func_225476_a(p_75529_1_, new BlockPos(this.spawnX, this.spawnY, this.spawnZ));
   ...
   private void spawnZombie(ServerWorld p_75530_1_) {
      Vec3d vec3d = this.func_225476_a(p_75530_1_, new BlockPos(this.spawnX, this.spawnY, this.spawnZ));
      if (vec3d != null) {
