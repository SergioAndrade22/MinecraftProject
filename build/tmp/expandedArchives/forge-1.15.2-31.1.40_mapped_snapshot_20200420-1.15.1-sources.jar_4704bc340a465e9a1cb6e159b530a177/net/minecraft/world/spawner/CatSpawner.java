...
public class CatSpawner {
   ...
   private int func_221121_a(ServerWorld worldIn, BlockPos p_221121_2_) {
      int i = 48;
      if (worldIn.getPointOfInterestManager().getCountInRange(PointOfInterestType.HOME.func_221045_c(), p_221121_2_, 48, PointOfInterestManager.Status.IS_OCCUPIED) > 4L) {
