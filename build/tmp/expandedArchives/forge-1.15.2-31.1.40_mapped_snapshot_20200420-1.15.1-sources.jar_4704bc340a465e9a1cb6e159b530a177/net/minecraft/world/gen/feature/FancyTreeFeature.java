...
public class FancyTreeFeature extends AbstractTreeFeature<TreeFeatureConfig> {
   ...
   public boolean func_225557_a_(IWorldGenerationReader generationReader, Random rand, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
      ...
      int i = this.func_227241_b_(generationReader, rand, p_225557_3_, 5 + random.nextInt(12), p_225557_4_, p_225557_6_, p_225557_7_);
      if (i == -1) {
         return false;
      } else {
         this.func_214584_a(generationReader, p_225557_3_.down());
         ...
         list.add(new FancyTreeFeature.ExtendedPos(p_225557_3_.up(i1), l));
         ...
         for(; i1 >= 0; --i1) {
            ...
            if (!(f < 0.0F)) {
               for(int j1 = 0; j1 < k; ++j1) {
                  ...
                  if (this.func_227235_a_(generationReader, rand, blockpos, blockpos1, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                     ...
                     if (this.func_227235_a_(generationReader, rand, blockpos2, blockpos, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
         ...
         this.func_227232_a_(generationReader, rand, i, p_225557_3_, list, p_225557_5_, p_225557_6_, p_225557_7_);
         this.func_227234_a_(generationReader, rand, p_225557_3_, j, p_225557_4_, p_225557_6_, p_225557_7_);
         this.func_227240_b_(generationReader, rand, i, p_225557_3_, list, p_225557_4_, p_225557_6_, p_225557_7_);
         return true;
      }
   }
