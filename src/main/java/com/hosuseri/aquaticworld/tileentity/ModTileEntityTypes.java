...
import com.hosuseri.aquaticworld.block.blocks.BlockQuarry;
...
public class ModTileEntityTypes{
	...
	public static final RegistryObject<TileEntityType<QuarryTileEntity>> quarry = TILE_ENTITY_TYPES.register(BlockQuarry.name, () -> TileEntityType.Builder.create(QuarryTileEntity::new, BlockInit.QUARRY.get()).build(null));
}