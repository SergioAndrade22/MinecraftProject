...
public class LeviathanDimensionChunckGenerator extends NoiseChunkGenerator<LeviathanDimensionGenerationSettings> {
	...
	public LeviathanDimensionChunckGenerator(IWorld worldIn, BiomeProvider provider, LeviathanDimensionGenerationSettings settingsIn) {
		super(worldIn, provider, 4, 8, 256, settingsIn, true);
		randomSeed.skip(2620);
		depthNoise = new OctavesNoiseGenerator(this.randomSeed, 15, 0);
		isAmplified = worldIn.getWorldInfo().getGenerator() == WorldType.AMPLIFIED;
	}
