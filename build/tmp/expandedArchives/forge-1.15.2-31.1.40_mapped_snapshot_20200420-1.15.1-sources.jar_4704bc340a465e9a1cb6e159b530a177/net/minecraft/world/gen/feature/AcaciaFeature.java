   ...
   public boolean func_225557_a_(IWorldGenerationReader generationReader, Random rand, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
      ...
      if (!optional.isPresent()) {
         ...
         for(int i2 = 0; i2 < i; ++i2) {
            ...
            if (this.func_227216_a_(generationReader, rand, blockpos$mutable.setPos(j1, j2, k1), p_225557_4_, p_225557_6_, p_225557_7_)) {
               l1 = j2;
            }
         }

         BlockPos blockpos1 = new BlockPos(j1, l1, k1);
         p_225557_7_.foliagePlacer.func_225571_a_(generationReader, rand, p_225557_7_, i, j, k + 1, blockpos1, p_225557_5_);
         j1 = blockpos.getX();
         k1 = blockpos.getZ();
         ...
         if (direction1 != direction) {
            ...
            for(int l2 = j3; l2 < i && k2 > 0; --k2) {
               if (l2 >= 1) {
                  ...
                  if (this.func_227216_a_(generationReader, rand, blockpos$mutable.setPos(j1, i3, k1), p_225557_4_, p_225557_6_, p_225557_7_)) {
                     l1 = i3;
                  }
               }
            ...
            if (l1 > 0) {
               ...
               p_225557_7_.foliagePlacer.func_225571_a_(generationReader, rand, p_225557_7_, i, j, k, blockpos2, p_225557_5_);
            }
         }
